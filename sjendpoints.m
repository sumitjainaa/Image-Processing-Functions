...
red(1:yminp,1:xminp)=0;
red(yminp:ymaxp,xminp:xmaxp,1)=a(yminp:ymaxp,xminp:xmaxp,1);

gr(1:yminp,1:xminp)=0;
gr(yminp:ymaxp,xminp:xmaxp,1)=a(yminp:ymaxp,xminp:xmaxp,2);

bl(1:yminp,1:xminp)=0;
bl(yminp:ymaxp,xminp:xmaxp,1)=a(yminp:ymaxp,xminp:xmaxp,3);
